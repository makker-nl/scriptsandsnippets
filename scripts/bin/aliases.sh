...
alias env-showctx="printf \"Current context: \";kubectl config current-context;echo \"Current namespace: \$NS\";echo \"Current OKE Environment: \$OKE_ENVIRONMENT\""
alias env-mgmt=". $POL_HOME/k8s_env.sh mgmt"
alias env-shared=". $POL_HOME/k8s_env.sh shared"
alias env-paas-ota=". $POL_HOME/k8s_env.sh paas-ota"
alias kc-mgmt="kubectl config use-context context-mgmt"
alias kc-shared="kubectl config use-context context-shared"
alias kc-paas-ota="kubectl config use-context context-paas-ota"
alias switch-mgmt="kc-mgmt;env-mgmt;env-showctx"
alias switch-paas-ota="kc-paas-ota;env-paas-ota;env-showctx"
alias switch-shared="kc-shared;env-shared;env-showctx"
